...
await get_document_price(city_sender='22244293-96d3-11ea-a970-b8830365ade4',
...
await get_document_delivery_date(city_sender='22244293-96d3-11ea-a970-b8830365ade4',
                                 city_recipient='4aa2b998-1988-11e5-add9-005056887b8d',
                                 service_type='WarehouseWarehouse'
                                 )

await get_status_documents(document_number='59000991136011',
                           phone='380674479448'
                           )

await create_express_waybill(payer_type='ThirdPerson',
