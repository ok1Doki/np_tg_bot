...
Також я маю наступні команди:
⚪ /tracking – Відстеження посилки
⚪ /cost – Розрахунок вартості послуги
⚪ /deliverytime – Інформування про терміни доставки
"""
...
async def post_init(application: Application):
    await application.bot.set_my_commands([
        ...
        BotCommand("/mode", "Обрати режим діалогу"),

        BotCommand("/tracking", "Відстеження посилки"),
        BotCommand("/cost", "Розрахунок вартості послуги"),
        BotCommand("/deliverytime", "Інформування про терміни доставки"),

        BotCommand("/settings", "Показати налаштування"),
        BotCommand("/help", "Показати підказки"),
    ])
